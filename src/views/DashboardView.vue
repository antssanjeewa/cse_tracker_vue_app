  ...
  const data = portfolioStore.holdings
    ...
    .map(h => {
      ...
      const marketStock = marketStore.allStocks.find(s => 
        (s.code || '').toUpperCase().split('.')[0] === tickerPrefix.toUpperCase().split('.')[0]
      )
      ...
      <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div class="xl:col-span-8">
           <SessionalPerformanceTable 
              ...
              @nextPage="currentPage < totalPagesCount && currentPage++"
